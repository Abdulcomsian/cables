...
<div class="bg-white mx-4 ticket hidden md:flex justify-between p-4 rounded-lg shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] mb-8">
  ...
  <div class="relative flex flex-col md:flex-row justify-between p-4">
    <!-- First Div Start -->
    <div
      class="absolute md:static top-20 left-0 sm:left-10 md:w-1/6 flex flex-col justify-center items-center"
    >
      <div class="w-28 h-16">
    ...
    <!-- Third Div Start -->
    <div
      class="relative md:w-1/6 flex flex-col justify-center items-center text-center"
    >
      <div
        class="absolute md:static xsm:left-24 ysm:left-32 sm:left-44 top-10 w-20 sm:w-40 md:w-full flex flex-col items-center"
      >
      ...
      <!-- <div class="w-10 md:w-full flex items-center">
  ...
  <div
    class="absolute left-14 top-[25.2rem] block sm:hidden text-[18px] text-[#000038]"
  >
